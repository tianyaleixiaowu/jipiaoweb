<template>
  <div class="searchMain">
      <SearchForm style="margin-bottom: 15px" v-if="hasSearch" v-bind:searchObj="tableConfig.searchObj" v-bind:searchUrl="tableConfig.searchUrl" v-bind:searchModel="getFormModel()">
      </SearchForm>
      ...
      <!-- table -->
      <ViewTable style="margin-top:15px" v-bind:table_column="table_column" v-bind:searchUrl="searchUrl" border ></ViewTable>
  </div>
</template>
...
export default {
  props: ['tableConfig', 'table_column', 'searchUrl', 'hasSearch'],
  data () {
    return {
